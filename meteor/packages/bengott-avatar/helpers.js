...
getGravatarUrl = function (user, defaultUrl, email) {
  var gravatarDefault;
...
getEmailOrHash = function (user, email) {
  ...
  if (Avatar.options.emailHashProperty) {
    ...
    emailOrHash = email || '00000000000000000000000000000000';
  }
  return emailOrHash;
};
